...
public class Prueba8 {
    ...
    void testFuncion8() {
        ...
        assertNotEquals(true, funcion.funcion8(tiempos, alumnos));
    }// 700
    ...
    void pruebaFuncion8_2() {
        ...
        alumnos.add("pepa");
        // le pasamos tres alumnos y abajo indicamos los tiempos de cada uno en un array
        // bidimensional.
        ...
        // es una prueba correcta, por que el resultado esperado coincide con la de la
        // funci�n.
    }
